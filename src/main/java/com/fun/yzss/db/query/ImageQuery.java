...
public class ImageQuery {
    ...
    final public static QueryDef FIND_ALL = new QueryDef(QueryType.SELECT, "SELECT * FROM `images`", new String[]{"id","type", "url", "sourceId","cosURI","tagList"});
    final public static QueryDef FIND_BY_TYPE = new QueryDef(QueryType.SELECT, "SELECT * FROM `images` where type={type}", new String[]{"id","type", "url", "sourceId","cosURI","tagList"});
